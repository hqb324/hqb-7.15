...
# 创建产品
def test_hqb1_addProd(pub_data):
    pub_data["productCode"] = "自动生成 字符串 5 数字 hqb"
...
# 下架
def test_hqb1_soldOut(pub_data):
    method = "POST"  #请求方法，全部大写
    feature = "用户模块"  # allure报告中一级分类
...
# 预售
def test_hqb1_toPreSale(pub_data):
    method = "POST"  #请求方法，全部大写
    feature = "用户模块"  # allure报告中一级分类
